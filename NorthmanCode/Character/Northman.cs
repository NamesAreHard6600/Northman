...
public class Northman : PlaceholderCharacterModel
{
    public const string CharacterId = "Northman";
    ...
    public override CardPoolModel CardPool => ModelDb.CardPool<NorthmanCardPool>();
